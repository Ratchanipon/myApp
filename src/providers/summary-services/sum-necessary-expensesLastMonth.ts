...
*/
@Injectable()
export class SumNecessaryExpensesLastMonthProvider {

  constructor(public http: HttpClient) {
    console.log('Hello SumNecessaryExpensessLastMonthProvider Provider');
  }

  getSumNecessaryExpensessLastMonth(){                          // ดึงข้อมูลรายการรายจ่ายที่ไม่จำเป็น
    ...
    return new Promise(resolve=>{
        ...
        .subscribe(data=>{
        resolve(data);      
        console.log('SumNecessaryExpensessLastMonthProvider++++++'+data);
